...
> [!IMPORTANT]
> Struktura MTZ jest walidowana na fixture i emulatorach, a import został
> pomyślnie przetestowany na fizycznym POCO F8 Ultra. Szczegóły oraz pozostałe
> ograniczenia zawiera [macierz zgodności](COMPATIBILITY.md).
...
[dokumentacji architektury](ARCHITECTURE.md).
...
| Fizyczne POCO F8 Ultra | import MTZ przetestowany pomyślnie |
...
- [Zgodność i ograniczenia](COMPATIBILITY.md)
